...
//go:generate mockgen -source remote_client.go -destination mock_remote_client.go -self_package github.com/slh92/rocketmq-client/internal/remote  --package remote RemotingClient
...
func (c *remotingClient) processCMD(cmd *RemotingCommand, r *tcpConnWrapper) {
	if cmd.isResponseType() {
		...
		if f != nil {
			...
			// TODO: optimize with goroutine pool, https://github.com/slh92/rocketmq-client/issues/307
			go primitive.WithRecover(func() {
